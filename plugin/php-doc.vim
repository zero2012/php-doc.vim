...
let g:pdv_cfg_Author = "zero <512888425@qq.com>"
let g:pdv_cfg_Copyright = "1997-" . strftime("%Y") . " The PHP Group"
let g:pdv_cfg_License = "PHP Version 3.0 {@link http://www.php.net/license/3_0.txt}"

"add by Martin
let g:pdv_cfg_Time = strftime("%Y-%m-%d %H:%M") 
let g:pdv_cfg_Date = strftime("%Y-%m-%d")
...
func! PhpDocFunc()
	...
	exe l:txtBOL . g:pdv_cfg_Comment1."@author " . g:pdv_cfg_Author g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Comment1."@created time :" . g:pdv_cfg_Time .g:pdv_cfg_EOL
...
func! PhpDocClass()
    ...
    " Local indent
    let l:txtBOL = g:pdv_cfg_BOL
	
    exe l:txtBOL . g:pdv_cfg_CommentHead . g:pdv_cfg_EOL
	"exe l:txtBOL . l:classname . "" . g:pdv_cfg_EOL
    "exe l:txtBOL . g:pdv_cfg_EOL
    if l:extends != "" && l:extends != "implements"
    	exe l:txtBOL . "@uses " . l:extends . g:pdv_cfg_EOL
    endif
	...
	while (l:interfaces != ",") && (l:interfaces != "")
		...
		exe l:txtBOL . "@uses " . l:interface . g:pdv_cfg_EOL
	endwhile

	if l:abstract != ""
        exe l:txtBOL . "@abstract" . g:pdv_cfg_EOL
    endif
	if l:final != ""
        exe l:txtBOL . " @final" . g:pdv_cfg_EOL
    endif

	exe l:txtBOL . g:pdv_cfg_Comment1."@package " . g:pdv_cfg_Package . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment1. g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment1."@version " . g:pdv_cfg_Version . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment1."@copyright " . g:pdv_cfg_Copyright . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment1."@author " . g:pdv_cfg_Author g:pdv_cfg_EOL
	"exe l:txtBOL . "@license " . g:pdv_cfg_License . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Comment1."@created time :" . g:pdv_cfg_Date .g:pdv_cfg_EOL
